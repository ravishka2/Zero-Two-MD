...
global.ytname = "YT:AdZone AD"
global.location = "SRILANKA,WESTERN PROVINCE KALUTHARA DODANGODA"
global.botscript = "https://github.com/ravishka2"
...
global.wlcm = []
global.gcrevoke = []
global.apikey = process.env.HEROKU_API_KEY_NEW || 'b074f97a-1fcc-4ce7-978f-f6703bdbbc42'
...
global.pengguna = 'AdZone_ADVERTISING BOT (❤️SAYU❤️ R+S) 𝐌𝐝' //username
global.mongodb = process.env.MONGODB_URI || "mongodb+srv://AdZoneADVERTISINGBOT:<AdZoneADVERTISINGBOT>@adzoneadvertisingbot.rcmitwp.mongodb.net/?retryWrites=true&w=majority"

global.port = process.env.PORT || 5000
global.botnma = process.env.botnma || 'AdZone_ADVERTISING BOT (❤️SAYU❤️ R+S) 𝐌𝐝'//bot name
global.watermark = "ENJOY WITH AdZone_ADVERTISING BOT (❤️SAYU❤️ R+S)"
global.botname = process.env.botnamw || 'AdZone_ADVERTISING BOT (❤️SAYU❤️ R+S)'
global.ownernma = 'Ikshwaku Pandey' //owner name
global.ownername = process.env.ownername || 'IM AdZone_ADVERTISING RAVISHKA❤️S❤️' //owner name
global.packname = 'AdZone_ADVERTISING BOT (❤️SAYU❤️ R+S)' //sticker package name
global.author = 'AdZone_ADVERTISING BOT (❤️SAYU❤️ R+S)' //sticker author name
global.sessionNamew = 'session.sam'
global.sessionName = process.env.SESSION_ID || 'U2FsdGVkX1/IvqRv7mbWeEKzKzv2xcc3fwv4xHvB7b4='
global.zerotwo = "https://github.com/ravishka2" //ur gc link
global.zerotwo2 = "https://github.com/ravishka2" //ur gc link2
global.websitex = "https://www.youtube.com/channel/UChAp2T6q9SlFIfhrFDZrzwA" //ur website
global.prefa = ['-'] //prefix
global.sp = '✨' //design
module.exports = {
  HEROKU: {
